...
public class LevelEditor : EditorWindow {
    ...
    void  OnGUI () {
        ...
        if (inventoryItemList != null) 
        {
            ...
            {
                GUILayout.BeginHorizontal ();
                viewIndex = Mathf.Clamp (EditorGUILayout.IntField ("Current Level", viewIndex, GUILayout.ExpandWidth(false)), 1, inventoryItemList.levels.Count);
                //Mathf.Clamp (viewIndex, 1, inventoryItemList.itemList.Count);
                EditorGUILayout.LabelField ("of   " +  inventoryItemList.levels.Count.ToString() + "  Levels", "", GUILayout.ExpandWidth(false));
                GUILayout.EndHorizontal ();
                ...
                if (level.board == null || level.board.Length == 0 || level.board.Length != level.rows * level.columns)
                {
